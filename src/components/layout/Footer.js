  ...
  <footer className="font-mono text-white bg-dark pt-24 pb-24 divide-y">
    <div className="container mx-auto divide-y divide-gray-700 pb-24">
      <div className="flow-root pb-32">
        <div className="px-8">
          <h3 className="font-bold spacing-xl text-4xl">Do you want an internship at FAANG?</h3>
          <p className="mt-3 text-xl font-medium">Join Exponential and become one of the 30 participants of our exclusive program!</p>
